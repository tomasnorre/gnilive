...
/**
 * Test case for class \Tnm\Gnilive\Domain\Model\Player.
 *
...
class PlayerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	{
		$this->subject = new \Tnm\Gnilive\Domain\Model\Player();
	}
	 ...
	 * @test
	 */
	public function getCaptainReturnsInitialValueForBool()
	{
		$this->assertSame(
			FALSE,
			$this->subject->getCaptain()
		);
	}
	 ...
	 * @test
	 */
	public function setCaptainForBoolSetsCaptain()
	{
		$this->subject->setCaptain(TRUE);
	...
	{
		$teamFixture = new \Tnm\Gnilive\Domain\Model\Team();
